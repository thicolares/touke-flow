...
class CurrentVersionViewHelper_Original extends \TYPO3\Fluid\Core\ViewHelper\AbstractConditionViewHelper {
 ...
 * View Helper which creates a control group form field based on twitter bootstrap
 */
class CurrentVersionViewHelper extends CurrentVersionViewHelper_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		parent::__construct();
		if ('Apimenti\Translator\ViewHelpers\CurrentVersionViewHelper' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('Apimenti\Translator\ViewHelpers\CurrentVersionViewHelper');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if ($reflectionService->isPropertyTaggedWith('Apimenti\Translator\ViewHelpers\CurrentVersionViewHelper', $propertyName, 'transient')) continue;
