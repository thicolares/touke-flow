 ...
 *
 */
class NumericNode_Original extends \TYPO3\Fluid\Core\Parser\SyntaxTree\AbstractNode {
...
class NumericNode extends NumericNode_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\Core\Parser\SyntaxTree\NumericNode', $propertyName, 'transient')) continue;
