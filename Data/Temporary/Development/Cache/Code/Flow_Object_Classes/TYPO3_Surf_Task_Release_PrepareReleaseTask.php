 ...
 *
 */
class PrepareReleaseTask_Original extends \TYPO3\Surf\Domain\Model\Task {
 ...
 * Task for preparing a "TYPO3.Release" release
 */
class PrepareReleaseTask extends PrepareReleaseTask_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if ('TYPO3\Surf\Task\Release\PrepareReleaseTask' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Surf\Task\Release\PrepareReleaseTask');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Surf\Task\Release\PrepareReleaseTask', $propertyName, 'transient')) continue;
