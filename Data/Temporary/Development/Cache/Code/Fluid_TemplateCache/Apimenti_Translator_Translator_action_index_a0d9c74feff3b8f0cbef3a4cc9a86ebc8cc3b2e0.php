<?php
class FluidCache_Apimenti_Translator_Translator_action_index_a0d9c74feff3b8f0cbef3a4cc9a86ebc8cc3b2e0 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
        ...
        <div class="row">
            ...
            <div class="col-10">
                <form class="form-inline">
                    <input type="text" class="form-control col-4" placeholder="Endereço de uma música no http://www.cifraclub.com.br">
