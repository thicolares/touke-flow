<?php
class FluidCache_Apimenti_Translator_Translator_action_index_d1102f427203adb729b4d6b2ad8412373e48a2f4 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
        ...
        <div class="row">
            ...
            <div class="col-10">
                <form class="form-inline">
                    <input type="text" class="form-control col-8" placeholder="Endereço de uma música no http://www.cifraclub.com.br">
