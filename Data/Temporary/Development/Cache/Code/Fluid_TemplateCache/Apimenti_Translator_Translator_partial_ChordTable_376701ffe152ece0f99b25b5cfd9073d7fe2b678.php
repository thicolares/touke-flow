<?php
class FluidCache_Apimenti_Translator_Translator_partial_ChordTable_376701ffe152ece0f99b25b5cfd9073d7fe2b678 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments10 = array();
$arguments10['chordRootNote'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'chord.chordRootNote', $renderingContext);
$arguments10['chordFormula'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'chord.chordFormula', $renderingContext);
$arguments10['then'] = NULL;
$arguments10['else'] = NULL;
$renderChildrenClosure11 = function() use ($renderingContext, $self) {
return NULL;
};
$viewHelper12 = $self->getViewHelper('$viewHelper12', $renderingContext, 'Apimenti\Translator\ViewHelpers\ChordBoxViewHelper');
