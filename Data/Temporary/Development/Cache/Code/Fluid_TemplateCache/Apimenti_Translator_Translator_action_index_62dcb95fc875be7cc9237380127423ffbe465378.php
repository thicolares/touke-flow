<?php
class FluidCache_Apimenti_Translator_Translator_action_index_62dcb95fc875be7cc9237380127423ffbe465378 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
        ...
        <div class="row">
            ...
            <div class="col-10">
                <form class="form-inline">
                    <input type="text" class="form-control" placeholder="Endereço de uma música no http://www.cifraClub.com.br">
                    <button type="submit" class="btn btn-success">Para Ukulele</button>
