<?php
class FluidCache_Apimenti_Translator_Translator_action_index_80bd7a073475d08295d86b8e6c6cdf7bd108450e extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
        ...
        <div class="row">
            ...
            <div class="col-10">
                <form class="form-inline">
                    <input type="text" class="form-control col-4" placeholder="Cole o endereço de uma música no http://www.cifraclub.com.br. Depois aperte a tecla ENTER.">
                </form>
            </div>
        </div>
