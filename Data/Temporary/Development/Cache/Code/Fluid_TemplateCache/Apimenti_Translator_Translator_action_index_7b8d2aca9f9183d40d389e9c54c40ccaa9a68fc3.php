<?php
class FluidCache_Apimenti_Translator_Translator_action_index_7b8d2aca9f9183d40d389e9c54c40ccaa9a68fc3 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
        ...
        <div class="row">
            ...
            <div class="col-10">
                <form class="form-inline">
                    ...
                    <button type="submit" class="btn btn-default">Para Ukulele</button>
                </form>
            </div>
        </div>
