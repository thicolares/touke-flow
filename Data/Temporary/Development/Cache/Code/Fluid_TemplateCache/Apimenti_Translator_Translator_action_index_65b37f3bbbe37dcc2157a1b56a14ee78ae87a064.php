<?php
class FluidCache_Apimenti_Translator_Translator_action_index_65b37f3bbbe37dcc2157a1b56a14ee78ae87a064 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
        ...
        <div class="row">
            ...
            <div class="col-10">
                <form class="form-inline">
                    <input type="text" class="form-control col-10" placeholder="Endereço de uma música no http://www.cifraclub.com.br">
                    <button type="submit" class="btn btn-success col-2">Para Ukulele</button>
