<?php
class FluidCache_Apimenti_Translator_Translator_action_index_197966252ac23be5b8128117b2768d7e0c84c031 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <small style="float:right"><em><p class="text-muted">ToUke v0.1.0a</p></em></small>
