...
class PersistedUsernamePasswordProvider extends PersistedUsernamePasswordProvider_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Flow\Security\Authentication\Provider\PersistedUsernamePasswordProvider', $propertyName, 'transient')) continue;
