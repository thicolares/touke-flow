 ...
 *
 */
class MigrateTask_Original extends \TYPO3\Surf\Domain\Model\Task {
 ...
 * A TYPO3 Flow migration task
 */
class MigrateTask extends MigrateTask_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if ('TYPO3\Surf\Task\TYPO3\Flow\MigrateTask' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Surf\Task\TYPO3\Flow\MigrateTask');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Surf\Task\TYPO3\Flow\MigrateTask', $propertyName, 'transient')) continue;
