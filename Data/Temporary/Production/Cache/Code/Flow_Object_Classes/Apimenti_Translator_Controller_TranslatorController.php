...
class TranslatorController_Original extends \TYPO3\Flow\Mvc\Controller\ActionController {
 ...
 * 
 */
class TranslatorController extends TranslatorController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if ('Apimenti\Translator\Controller\TranslatorController' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('Apimenti\Translator\Controller\TranslatorController');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if ($reflectionService->isPropertyTaggedWith('Apimenti\Translator\Controller\TranslatorController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		$this->injectSettings(\TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Flow\Configuration\ConfigurationManager')->getConfiguration(\TYPO3\Flow\Configuration\ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, 'Apimenti.Translator'));
		$this->songParserService = new \Apimenti\Translator\Service\SongParserService();
...
return array (
  ...
  array (
    ...
    array (
      'position' => 0,
      'optional' => true,
      'type' => 'Apimenti\\Translator\\Domain\\Dto\\Song',
      'class' => 'Apimenti\\Translator\\Domain\\Dto\\Song',
      'array' => false,
      'byReference' => false,
      'allowsNull' => true,
      'defaultValue' => NULL,
