 ...
 *
 */
class SymlinkReleaseTask_Original extends \TYPO3\Surf\Domain\Model\Task {
 ...
 * A symlink task for switching over the current directory to the new release
 */
class SymlinkReleaseTask extends SymlinkReleaseTask_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if ('TYPO3\Surf\Task\SymlinkReleaseTask' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Surf\Task\SymlinkReleaseTask');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Surf\Task\SymlinkReleaseTask', $propertyName, 'transient')) continue;
