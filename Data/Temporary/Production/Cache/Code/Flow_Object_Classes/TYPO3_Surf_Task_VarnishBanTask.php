 ...
 */
class VarnishBanTask_Original extends \TYPO3\Surf\Domain\Model\Task {
 ...
 * * varnishadm - path to the varnishadm utility, defaults to "/usr/bin/varnishadm"
 */
class VarnishBanTask extends VarnishBanTask_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if ('TYPO3\Surf\Task\VarnishBanTask' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\Surf\Task\VarnishBanTask');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Surf\Task\VarnishBanTask', $propertyName, 'transient')) continue;
