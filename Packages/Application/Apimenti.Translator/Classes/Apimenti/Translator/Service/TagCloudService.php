 ...
 * @package Apimenti\Translator\Service
 * @see https://github.com/lotsofcode/tag-cloud
 */
class TagCloudService {
    ...
    /**
     * Set Formatting Array
     */
    public function setFormatting($formatingArray) {
        $this->_formatting = $formatingArray;
    }
